...
export interface JuradoConfirmDialogData {
  title: string;
  message: string;
  confirmText: string;
...
export interface JuradoConfirmDialogResult {
  confirmed: boolean;
  observation: string;
}

@Component({
  selector: 'app-jurado-confirm-action-dialog',
  standalone: true,
...
export class ConfirmActionDialogComponent {
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) public readonly data: JuradoConfirmDialogData,
    private readonly dialogRef: MatDialogRef<ConfirmActionDialogComponent, JuradoConfirmDialogResult>,
  ) {}
